"use strict";
// Built around ShellTear's POC at #2215#issuecomment-1292885678 on @whiskeysockets/baileys
// Copyright ~ purpshell
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        _b = (_a = Buffer)
                            .from;
                        return [4 /*yield*/, node_crypto_1.webcrypto.subtle.digest('SHA-256', (new TextEncoder).encode(option))];
                    case 2:
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        createSignKey = function (n) {
                            ...
                            return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, node_crypto_1.webcrypto.subtle.importKey('raw', n, { 'name': 'HMAC', 'hash': 'SHA-256' }, false, ['sign'])];
                        ...
                        sign = function (n, key) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, node_crypto_1.webcrypto.subtle.sign({ 'name': 'HMAC', 'hash': 'SHA-256' }, key, n)];
                                    case 1: return [2 /*return*/, (_a.sent())];
                                }
                            });
                        }); };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        encoded = encPayload;
                        return [4 /*yield*/, node_crypto_1.webcrypto.subtle.importKey('raw', decryptionKey, 'AES-GCM', false, ['encrypt', 'decrypt'])];
                    case 1:
                        key = _a.sent();
                        return [4 /*yield*/, node_crypto_1.webcrypto.subtle.decrypt({ name: 'AES-GCM', iv: encIv, additionalData: additionalData, tagLength: 8 * tagSize_multiplier }, key, encoded)];
                    case 2:
                        decrypted = _a.sent();
